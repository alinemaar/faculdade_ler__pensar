...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    setIdTarefaParaDeletar(id); // Armazena o ID da tarefa a ser deletada temporariamente
    setOpenDelete(true); // A
  };

  const handleDeletarConfirmado = () => {
    setTarefas((current) =>
      current.filter((tarefa) => tarefa.idTarefa !== idTarefaParaDeletar)
    );
    setOpenDelete(false); // Fecha o modal de confirmação de exclusão
    setIdTarefaParaDeletar(null); // Limpa o ID da tarefa
  };
      ...
      <div>
        ...
        <div>
          <ModalDelete
            ...
            onSubmit={handleDeletarConfirmado}
          />
        </div>
      </div>
    </>
